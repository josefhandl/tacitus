...
class WireguardPeerTransfer(BaseModel):
    ...
    def __init__(self, received, sent):
        super().__init__(received=received, sent=sent)
...
class WireguardPeer(BaseModel):
    ...
    def __init__(self, peer, endpoint, allowed_ips, latest_handshake, transfer):
        super().__init__(
            peer=peer,
            endpoint=endpoint,
...
class WireguardStatus(BaseModel):
    ...
    def __init__(self, interface, peers):
        super().__init__(interface=interface, peers=peers)
